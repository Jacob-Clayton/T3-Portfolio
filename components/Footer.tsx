        ...
        <section className={`${styles.paddings} relative sm:pb-[60px]`}>
            <div className={`${styles.innerWidth} ${styles.descriptionText} mx-auto`}>
                ...
                <p className="mt-6 flex flex-wrap items-center gap-1">
                    Built with 
                    <span><Image src={'/typescript.svg'} className="ml-1" width={18} height={18} alt="typescript"/></span>
                    Typescript,
                    <span><Image src={'/tailwind.svg'} className="ml-1" width={18} height={18} alt="tailwind"/></span>
                    Tailwind and
                    <span><Image src={'/nextjs.svg'} className="ml-1" width={18} height={18} alt="next"/></span>
                    Next.js. Deployed on 
                    <span><Image src={'/vercel.svg'} className="ml-1" width={18} height={18} alt="next"/></span>
                    Vercel.
                </p>
            </div>
        </section>
